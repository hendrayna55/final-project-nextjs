        ...
        <>
            <div>
                ...
                <div className="flex flex-col min-h-screen bg-japan">
                    ...
                    <main>
                        {postMe?.isLoading || dataUser?.isLoading ? (
                                            ...
                                            <div className="bg-gray-800 bg-opacity-80 rounded-lg shadow-md py-5 px-7 text-white">
                                                <div className='flex justify-between items-center'>
                                                    <div className=''>
                                                        <div
                                                            ...
                                                            style={{ backgroundColor: stringToColor(dataUser?.data?.data.name) }}
                                                        >
                                                            {getInitials(dataUser?.data?.data.name)}
                                                        </div>
                                                    </div>

                                                    <div>
                                                        <div className='flex flex-col items-end'>
                                                            <h4 className='text-2xl font-bold'>{dataUser?.data?.data.name}</h4>
                                                            <p className='text-sm'>{dataUser?.data?.data.email}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className='mt-4 grid grid-cols-3'>
                                                    <div className='text-center'>
                                                        ...
                                                        <p className='text-sm'>
                                                            {
                                                                dataUser?.data?.data.dob ? 
                                                                new Date(dataUser?.data?.data.dob).toLocaleDateString(
                                                                    'id-ID', 
                                                                    {
                                                                        day: '2-digit',
                                                                        month: 'long',
                                                    ...
                                                    <div className='text-center'>
                                                        ...
                                                        <p className='text-sm'>{dataUser?.data?.data.hobby || '-'}</p>
                                                    </div>
                                                    <div className='text-center'>
                                                        <h5 className='text-md font-bold'>Phone</h5>
                                                        <p className='text-sm'>{dataUser?.data?.data.phone || '-'}</p>
                                                    </div>
                                                </div>
                                            </div>
